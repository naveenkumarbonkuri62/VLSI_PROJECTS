...
REM
REM Generated by Vivado on Fri Feb 06 22:03:49 +0530 2026
...
echo "xvlog --incr --relax -prj CountingOne_GateLevel_vlog.prj"
call xvlog  --incr --relax -prj CountingOne_GateLevel_vlog.prj -log xvlog.log
